...
const focusAreas = [
  {
    ...
    description:
      "Designing human-in-the-loop AI agents that handle research, summarisation, and execution across complex workflows.",
  },
  {
    title: "Automation playbooks",
    description:
      "Building resilient automation pipelines with n8n, LangChain, and custom orchestration to remove operational drag.",
  },
  {
    title: "Insightful tooling",
    description:
      "Shipping dashboards and internal tools that surface the right signal for product, GTM, and support teams.",
  },
];
...
const sprintHighlights = [
  {
    title: "Signal intake",
    description:
      "Connected Salesforce, Intercom, and Slack queues into a single triage feed.",
  },
  {
    title: "Agentic triage",
    description:
      "LangChain flows summarised tickets and proposed replies in under six seconds.",
  },
  {
    title: "Human QA loop",
    description:
      "CX leads reviewed edge cases weekly to retrain prompts and workflows.",
  },
];
...
export default function Home() {
  return (
    <div className="relative isolate overflow-hidden bg-gradient-to-b from-[#f5f3ff] via-white to-[#e0f2fe]">
      ...
      <header className="mx-auto flex max-w-6xl flex-col gap-10 px-6 pb-20 pt-6 lg:px-8 lg:pt-12">
          ...
          <div className="space-y-9">
            ...
            <div className="space-y-6 text-lg text-slate-600">
              <p className="max-w-xl leading-relaxed">
                I help teams move from ideas to production-ready AI experiences.
                From orchestrating multi-agent workflows to automating the
                unglamorous ops, I focus on shipping quickly without sacrificing
                reliability.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #a5b4fc 0%, #c4b5fd 50%, #bae6fd 100%)",
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-2xl border border-slate-200 bg-white/60 p-5 shadow-sm shadow-slate-900/5"
                >
            ...
            <div className="space-y-6 text-slate-700">
              <div className="flex items-center gap-4 rounded-2xl border border-indigo-100 bg-white/70 p-4 shadow-sm shadow-indigo-500/5">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-indigo-700">
                    Ops intake &gt; Agent routing &gt; Human QA
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm leading-relaxed text-slate-600">
                  Partnered with the CX org to launch a multi-modal workflow
                  that triages inbound requests, synthesises context, and drafts
                  responses in under six seconds.
                </p>
              </div>
                  ...
                  <li key={item.title} className="relative flex gap-4">
                    <div className="flex flex-col items-center">
                      ...
                      {index < sprintHighlights.length - 1 && (
                        <span
                          className="mt-1 h-full w-px bg-indigo-100"
                          aria-hidden="true"
                        />
                      )}
                    </div>
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-20 px-6 pb-24 lg:px-8">
        <section
          id="focus"
        ...
        >
          ...
          <div className="flex flex-col gap-4 rounded-2xl border border-indigo-200 bg-gradient-to-br from-indigo-500 via-indigo-400 to-violet-400 p-6 text-white transition-transform duration-200 hover:-translate-y-1">
            ...
            <p className="text-sm leading-relaxed text-white/80">
              My approach is tightly scoped experiments that ship within days,
              instrumented with the right analytics, and iterated until the
              impact compounds.
            </p>
          </div>
        </section>
        <section id="work" className="space-y-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="text-sm text-slate-600">
                A snapshot of recent projects that pair automation with tangible
                business outcomes.
              </p>
            </div>
            <Link
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {projects.slice(0, 3).map((project, index) => (
              ...
              >
                {project.impact && (
                  <div className="inline-flex items-center gap-2 text-[11px] font-medium text-indigo-500">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.05fr,0.95fr]">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl font-semibold">
                Ready to unlock the next automation lever?
              </h2>
              <p className="text-base leading-relaxed text-white/80">
                Whether you need to prototype an AI assistant, automate
                mission-critical workflows, or audit an existing pipeline, I can
                help scope, build, and iterate alongside your team.
              </p>
              <ul className="space-y-2 text-sm text-white/75">
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 rounded-full bg-white/60" />
                  Rapid discovery sprints to map the automation opportunity and
                  define success metrics.
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 rounded-full bg-white/60" />
                  Build-and-measure loops so your team sees value before
                  committing to long roadmaps.
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 rounded-full bg-white/60" />
                  Embedded collaboration with product, GTM, and ops to keep
              ...
              <p className="text-xs text-white/65">
                Prefer scheduling time directly? Drop a note in the form and
                I&apos;ll share calendar slots.
              </p>
            </div>
            <ContactForm />
          </div>
