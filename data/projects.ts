...
export const projects: Project[] = [
  {
    ...
    solution:
      "Built a 6 page Next.js 14 website with responsive design, an email backend for contact forms and quote requests using Nodemailer, and premium UI with smooth animations.",
  ...
  },
  {
    ...
    impact: "Live production website serving customers with a streamlined booking flow",
  ...
  },
  {
    ...
    challenge:
      "The music industry needs data driven insights to predict which songs will resonate with audiences.",
    solution:
